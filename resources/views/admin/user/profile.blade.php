            ...
            <div class="col-md-3">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="{{elixir($userInfo['profile']['avatar'])}}" alt="User profile picture">
                        <h3 class="profile-username text-center">{{$userInfo['name']}}</h3>
                        <p class="text-muted text-center">{{$userInfo['profile']['job']}}</p>
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;锁定 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#timeline" data-toggle="tab">所有权限</a></li>
                        <li><a href="#settings" data-toggle="tab">操作日志</a></li>
                    </ul>
